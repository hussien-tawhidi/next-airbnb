  ...
  return (
    <>
      <div className='flex justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800/70'>
        <div className='relative w-full md:w-4/6 lg:w-3/6 xl:w-2/5 my-6 max-auto h-full lg:h-auto md:h-auto'>
          {/* content */}
          <div
            ...
            <div className='translate h-full lg:h-auto md:h-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
              ...
              <div className='flex items-center justify-center p-6 rounded-t relative border-b-[1px]'>
                <button
                  className='p-1 border-0 hover:opacity-75 transition absolute left-9'
                  onClick={handlwClose}>
                  <IoMdClose size={18} />
                </button>
